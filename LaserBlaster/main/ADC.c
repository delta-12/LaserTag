...
//We want this Portion of Code - ADC Channel 0
#if EXAMPLE_USE_ADC2
//ADC2 Channels
#if CONFIG_IDF_TARGET_ESP32
...
//We only want this portion of code as it pertains to Pin4 ADC2 Channel0
#if EXAMPLE_USE_ADC2
        ...
        if (do_calibration2) {
            ...
            //built-in voltage thresholds using 4.7k and 47K resistors inside clips
            if((voltage[1][0] < 1500) || (voltage[1][0] >= 1900 && voltage[1][0] <= 2950) || (voltage[1][0] > 3050)){
                printf("Invalid Clip\n");
            }else if(voltage[1][0] >= 1500 && voltage[1][0] < 1800){
                printf("Clip1\n");
            }else{
                printf("Clip2\n");
            }
        }
        //reduce delay and check for change from voltage thresholds into appropriate thresholds
